...
import {
  ...
  Sparkles, Brain, Shield, Zap, Bot, Check, Chrome,
} from 'lucide-react'
            ...
            <div className="bg-white/95 backdrop-blur-2xl rounded-3xl border border-white/20 shadow-2xl shadow-black/20 overflow-hidden relative">
              ...
              <div className="p-6 space-y-4">
                ...
                {GOOGLE_CLIENT_ID ? (
                  ...
                  /* Fallback: disabled Google button with setup hint */
                  <div className="space-y-3">
                    <button
                      type="button"
                      disabled
                      title="Set VITE_GOOGLE_CLIENT_ID in .env to enable"
                      className="w-full py-3 flex items-center justify-center gap-3 border border-slate-200 rounded-xl bg-slate-50 text-slate-400 text-sm cursor-not-allowed"
                    >
                      <Chrome className="w-4 h-4" />
                      Continue with Google
                      <span className="text-[10px] bg-slate-200 text-slate-500 px-1.5 py-0.5 rounded-full ml-1">Setup required</span>
                    </button>
                    <div className="flex items-center gap-3">
                      <div className="flex-1 h-px bg-slate-200" />
                      <span className="text-xs font-medium text-slate-400">or continue with email</span>
